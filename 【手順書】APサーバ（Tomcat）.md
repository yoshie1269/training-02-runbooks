...
## 1. root ユーザーへ切り替え、作業ディレクトリへ移動する
...
## 2. Amazon Corretto（JDK）をダウンロードする
...
# APサーバ構築 手順書②（Tomcat インストール・サービス化）
...
# APサーバ構築 手順書③（Apache 連携・アプリ配備・動作確認）
